				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<center><img src="{{asset('vendors/images/Dorra_DHAHRI.png')}}" alt="" style="width: 40%;"></center>
                        ...
                        @endisset
							...
							<div class="input-group custom">
								<input id="email" type="email" placeholder="Exemple@gmail.com" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
